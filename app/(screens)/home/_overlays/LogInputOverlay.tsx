    ...
    >
      <div className="flex gap-2 items-center">
        ...
        <div className="w-full font-bold">
          <Link href={`${pathname}?${params.toString() + '&'}category-select=show`} className={isPending ? 'pointer-events-none' : ''}>
            <p className="text-sm">
      ...
      <div className="flex flex-col gap-2">
        ...
        {!!category?.fields.length && <ul className={`flex gap-3 flex-wrap ${isPending ? 'pointer-events-none' : ''}`}>
